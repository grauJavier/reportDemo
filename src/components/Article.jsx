...
function Article__Header(props) {
  ...
  return (
    <div className="flex flex-col items-center">
      <img src={imgSrc} width="980" height="634" alt={imgAlt} />
      <span className="fig-caption -rotate-45 border border-t-[2px] border-[#FF004D] w-1/4 relative mb-11" />
      <h3 className="oswald-600 text-[#FF004D] mx-[27%] uppercase text-center text-[22px] text-pretty leading-6 tracking-tighter">
        {title}
      </h3>
    </div>
  );
...
function Article__Paragraph(props) {
  return <p className="playfair-display-400 text-[1.3rem] leading-8 mb-8">{props.children}</p>;
}
  ...
  return (
    <div className="flex flex-col justify-end px-5 h-dvh">
      <div className="flex flex-col justify-items-start">
        <div className="flex items-center justify-center p-5 aspect-square w-fit bg-[#FF004D] playfair-display-900 text-white text-2xl">
          P:
        </div>
